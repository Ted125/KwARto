...
$uploadfile = $uploaddir . basename("".$_SESSION['sellerId']."_secdti") . $fileExtension;  

$db = new Database();
$connection = $db->Connect();
$result = null;
if($connection){
    $result = mysqli_query($connection, "UPDATE seller SET secdti_reg = 1 WHERE sellerId = '".$_SESSION['sellerId']."'");
}

if (move_uploaded_file($_FILES['newData1']['tmp_name'], $uploadfile)) {
