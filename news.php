							...
							<div class="owl-item product_slider_item">
								<div class="product-item homeacc">
									<div class="product">
										...
										<div class="favorite"></div>
										<div class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center"><span>-P1000</span></div>
										<div class="product_info">
											<h6 class="product_name"><a href="#single.php">Blue Bedroom Desk</a></h6>
											<div class="product_price">P4,000<span>P5,000.00</span></div>
										</div>
									</div>
								</div>
							</div>
